...
getWordCloudNews (coinName: any){
  ...
  this.http.post<any>('https://etherkat.com/get-google-news', body, { headers }).subscribe(data => {
    let details = data;
...
getCoinTrends(coinName: any){
  ...
  let params = new HttpParams()
    .set("coin", coinName)
  this.http.get(`https://etherkat.com/get-summary-page?coin=${coinName}&days=365`, {
    headers: headers,
    params: params,
    responseType: 'text'
