...
// // export const CoinSelection: any = {};
// // let CoinSelection;
// const CoinSelectionSL = (async () => {
...
//     const newAmount: any = Loader.Cardano.Value.new(
...
//    * @return {AmountList}
//    */
//   function splitAmounts(amounts: any) {
//     let splitAmounts: any = [];
...
//    */
//   let protocolParameters: any = null;
...
//      */
//     setProtocolParameters: (minUTxO: any, minFeeA: any, minFeeB: any, maxTxSize: any) => {
//       protocolParameters = {
//         minUTxO: minUTxO,
//         minFeeA: minFeeA,
//         minFeeB: minFeeB,
...
//      */
//     randomImprove: async (inputs: any, outputs: any, limit: any) => {
...
// // CoinSelectionSL()
// export default CoinSelectionSL;