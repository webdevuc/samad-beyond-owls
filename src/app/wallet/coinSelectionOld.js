...
//   let CoinSelection;
// // export default CoinSelectionSL = async () => {}
// async function CoinSelectionSL () {
//   const S = await import('@emurgo/cardano-serialization-lib-browser/cardano_serialization_lib.js')

// // import NamiLoader from '../services/nami-loader.service'
...
// // export default CoinSelection = async () => {

//     // const S = NamiLoader.Cardano();
//       const Loader = {
//         Cardano: S
//       }
//       /**
...
// }
// CoinSelectionSL();
// console.log("Josng data: ", JSON.stringify(CoinSelection));
// export default CoinSelection;