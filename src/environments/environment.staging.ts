const URL = 'https://backend-grise.invo.zone';
export const environment = {
  ...
  adminNamiWalletAddress: 'addr_test1qrwyj82j9peesjqvs98qfeefssrvx9m6xxj3nj6ntavtxm2yqt29wjru9ggwf6w08zlr0qj947dww4anaje9h00m6k3swvqrq3',
  ADMIN_ROYALITY: 1.77,
  ASSET_TRANSFER_PRICE: 1.5,
  TRIPPY_OWL_COLLECTION_PRICE: 3,
  SERVER_URL: URL,
  baseUrlAPI: `${URL}/api/v0/nft`
};
